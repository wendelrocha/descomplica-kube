...
- Definição do Kubernetes
- Definição de containers
- Definição sobre a Open Containers Initiative
- Definição sobre os container engine e container runtime
- Arquitetura do Kubernetes
- Portas TCP de Entrada usadas pelos componentes da arquitetura do Kubernetes, demonstrando o seu propósito e uso
